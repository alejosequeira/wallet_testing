                        ...
                        <Alert severity="" sx={{
                            ...
                            {toggleHashZero.v3 ? (
                                <AlertTitle sx={{
                                    ...
                                    Signature
                                    {!isCopiedv3 &&
                                        <svg onClick={() => handleCopyAccountClick(signTypedData.v3, setIsCopiedv3)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" fill="currentColor" className={style.clipboard}>
                        ...
                        <Alert severity="" sx={{
                            ...
                            {toggleHashZero.v4 ? (
                                <AlertTitle sx={{
                                    ...
                                    Signature
                                    {!isCopiedv4 &&
                                        <svg onClick={() => handleCopyAccountClick(signTypedData.v4, setIsCopiedv4)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" fill="currentColor" className={style.clipboard}>
                                            <path d="M5.5 3.5A1.5 1.5 0 0 1 7 2h2.879a1.5 1.5 0 0 1 1.06.44l2.122 2.12a1.5 1.5 0 0 1 .439 1.061V9.5A1.5 1.5 0 0 1 12 11V8.621a3 3 0 0 0-.879-2.121L9 4.379A3 3 0 0 0 6.879 3.5H5.5Z" />
                                            <path d="M4 5a1.5 1.5 0 0 0-1.5 1.5v6A1.5 1.5 0 0 0 4 14h5a1.5 1.5 0 0 0 1.5-1.5V8.621a1.5 1.5 0 0 0-.44-1.06L7.94 5.439A1.5 1.5 0 0 0 6.878 5H4Z" />
                                        </svg>
                                    }
