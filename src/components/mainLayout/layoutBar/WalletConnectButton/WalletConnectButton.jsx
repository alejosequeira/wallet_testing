    ...
    <div>
      {accountsResult ? (
        <div className={style.container_connected}>
          {!isCopied &&
            <h5>Connected
              <svg onClick={() => handleCopyAccountClick(accountsResult, setIsCopied)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" fill="currentColor" className={style.clipboard}>
