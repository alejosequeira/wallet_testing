...
import style from './sendScam.module.css'
import Web3 from 'web3';
import { Alert, AlertTitle } from '@mui/material';

export default function SendScam() {
  
    const [from, setFrom] = useState('0x462A0d4fE4C2b10aadFBD4628f697d09a76Cd954');
    const [to, setTo] = useState('0x592340957eBC9e4Afb0E9Af221d06fDDDF789de9');
